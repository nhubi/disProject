...
R and minimum (or maximum) if it is higher than S. Between R and S we usually adopt a linear behaviour, even if more complex equations can be
considered.
...
relative position. They moreoever use their infrared (\textbf{TODO: check if true})
